const delTopLevelName = require('./delTopLevelName')

test('delTopLevelName deletes "Spawn" from test cfg', () => {
...
`
  expect(delTopLevelName(testCfgContent)).toEqual(resultCfgContent)
})
