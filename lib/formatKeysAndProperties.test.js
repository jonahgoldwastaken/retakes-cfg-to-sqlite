const formatKeysAndProperties = require('./formatKeysAndProperties')

test('formatKeysAndProperties formats keys and properties properly', () => {
...
`
  expect(formatKeysAndProperties(testCfgContent)).toMatchSnapshot(
    'keysAndPropertiesFormatted'
  )
})
